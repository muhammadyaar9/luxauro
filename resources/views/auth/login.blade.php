                ...
                <div class="sign-in col-md-7 px-3 px-md-0">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="input-group flex-nowrap mb-3">
                            ...
                            <span class="input-group-text" id="addon-wrapping"><i class="fa fa-user-o"
                        ...
                        <div class="input-group flex-nowrap mb-3">
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
                                ...
                                aria-label="Username" aria-describedby="addon-wrapping">
                            <span class="input-group-text" id="addon-wrapping"><i class="fa fa-lock"
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="{{ route('password.request') }}" class="mb-0 border-bottom d-inline-block">Forget your
                                password?</a>
                        </div>
                        <div class="account">
                            <p>Don't have an account? <a href="{{ route('register') }}"
                                    class="mb-0 border-bottom d-inline-block mx-1">Create an account</a></p>
                        </div>
                    </form>
                </div>
            </div>
