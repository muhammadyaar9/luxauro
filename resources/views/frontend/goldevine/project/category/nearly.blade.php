...
@section('title')
    <title>All Golveine Nearly Projects </title>
@endsection
@section('content')
                ...
                <div class="product-section mb-5 pb-lg-3">
                    <div class="container">
                        <div class="d-md-flex justify-content-between align-items-center flex-wrap mb-3">
                            <div class="mb-3 mb-md-0">
                                <ol class="breadcrumb mb-1">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">All Nearly Projects
                                    </li>
                                </ol>
                            </div>
                        </div>
                        <div class="Luxaurolicious-slider ">
                            <div class="row mb-3">
                                @forelse ($goldevinenearly as $goldevine)
                                    @php
                        ...
                        <div class="d-flex justify-content-center mt-2">
                            {!! $goldevinenearly->appends(Request::all())->links() !!}
                        </div>
                        <div class=" mb-4">
