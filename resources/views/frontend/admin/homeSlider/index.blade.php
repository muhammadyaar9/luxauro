        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flux">
                    ...
                    <a href="{{ route('home-slider.create') }}" class="btn btn-outline-primary float-end">Create Banner</a>
                </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('home-slider.edit', $banner->id) }}"><i
                                                        class="bx bx-edit-alt me-1 text-success"></i> Change Status </a>
                                                <a class="dropdown-item" href="{{ route('home-slider.destroy',$banner->id) }}"  onclick="event.preventDefault();
                                                document.getElementById('logout-form{{ $banner->id}}').submit();"><i
                                                        class="bx bx-trash me-1 text-danger"></i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                    <form id="logout-form{{ $banner->id}}" action="{{ route('home-slider.destroy',$banner->id) }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
