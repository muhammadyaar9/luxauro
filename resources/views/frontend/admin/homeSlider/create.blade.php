...
@section('title')
    <title>Create Home Slider banner</title>
@endsection
@section('content')
    <div class="row">
        <!-- Form controls -->
        <div class="col-md-12">
            <div class="card mb-4">
                <h5 class="card-header">Create Home Slider banner</h5>
                <div class="card-body">
                    <form action="{{ route('home-slider.store') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="row py-3">
                                <div class="col-sm-12 text-end">
                                    <a href="{{ route('home-slider.index') }}" class="btn btn-outline-danger mx-2">Closed</a>
