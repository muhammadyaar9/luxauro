        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flux">
                    ...
                    @if ($aboutcount == null)
                        <a href="{{ route('goldevine-rule.create') }}" class="btn btn-outline-primary btn-sm float-end"><i
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{ route('goldevine-rule.edit', $aboutUs->id) }}"
                                                    class="btn btn-primary btn-sm">Edit<i class="fa fa-edit"></i></a>
                                                <a href="{{ route('goldevine-rule.destroy', $aboutUs->id) }}"
