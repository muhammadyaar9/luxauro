...
@section('title')
    <title>Edit Learn About The Tribrid</title>
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('learn-about-tribrid.update' , $aboutUs->id ) }}" enctype="multipart/form-data" method="post">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="id" value="{{ $aboutUs->id }}">
                        <div class="row">
                            <input type="hidden" name="type" value="Tribrid">
                            <div class="col-md-12 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="title" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="title"
                                        title="title" value="{{ $aboutUs->title }}" />
                                    @error('title')
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="learn_about_description" id="" class="form-control @error('learn_about_description') is-invalid @enderror">{{ $aboutUs->learn_about_description }}</textarea>
                            ...
                            <div class="row py-3">
                                <div class="col-sm-12 text-end">
                                    <a href="{{ route('learn-about-tribrid.index') }}" class="btn btn-outline-danger mx-2">Closed</a>
