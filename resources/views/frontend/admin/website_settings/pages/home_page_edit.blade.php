			...
			<div class="card-body">
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="home-slider-target mb-2">
										...
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
													...
													<input type="file" name="types[]" value="home_slider_images" class="form-control file-amount">
					...
					<div class="text-right">
						<button type="submit" class="btn btn-outline-primary float-end">{{ translate('Update') }}</button>
					</div>
				</form>
			</div>
		</div>
			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="home-banner1-target mb-2">
		...
		<div class="card mb-4">
			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>{{ translate('Banner & Links') }}</label>
						<div class="home-banner2-target mb-2">
										...
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
													<input type="file" name="types[]" value="home_banner2_images" class="form-control file-amount">
		...
		<div class="card mb-4">
			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>{{ translate('Banner & Links') }}</label>
						<div class="home-banner3-target mb-2">
