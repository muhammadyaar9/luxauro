...
@section('title')
    <title>Create Shipping Type</title>
@endsection
@section('content')
    <div class="row">
        <!-- Form controls -->
        <div class="col-md-12">
            <div class="card mb-4">
                <h5 class="card-header">Create Shipping Type</h5>
                <div class="card-body">
                    <form action="{{ route('shipping-type.store') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="row">
