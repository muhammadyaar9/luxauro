                ...
                <div class="row col-lg-9 mx-auto gx-5">
                    ...
                    <div class="col-12 col-md-7 gx-0 gx-md-1 gx-lg-5 px-lg-5">
                        <div class="my-account-section">
                            ...
                            <form action="{{ route('storeProjectgoldevine') }}" enctype="multipart/form-data"
                                method="post">
                                @csrf
                                        ...
                                        <div class="my-account-section business-information">
                                            ...
                                            <div class="text-area">
                                                ...
                                                <textarea class="form-control mb-4 @error('description')  is-invalid @enderror" placeholder=""
                                                    id="exampleFormControlTextarea1" rows="3" name="description" class="description">{{ old('description') }}</textarea>
                                                @error('description')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    @enderror
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="shoert_description_project" value="{{ old('shoert_description_project') }}">
                                                <div class="pincel"></div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="city_tag" name="tags" data-role="tagsinput">
                                                @error('tags')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    @enderror
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <label class="uploadFile border rounded">
                                                    <i class="fa fa-cloud-upload upload-icon-account-1"
                                                        aria-hidden="true"></i>
                                                    <span class="filename">file</span>
                                                    <input type="file" class="inputfile form-control @error('gallery_image')
                                                    is-invalid @enderror "
                                            ...
                                            <div class="mb-3">
                                                ...
                                                is-invalid @enderror"
                                                    placeholder="https://" name="video_link" value="{{ old('video_link') }}">
                                                <div class="pincel"></div>
                                                @error('video_link')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                is-invalid @enderror"
                                                    ...
                                                    <option
                                                        value="Target Goal"{{ old('project_end_method') == 'Target Goal' ? 'selected' : '' }}>
                                                        Target Goal</option>
                                                    <option value="Target Date"
                                                        {{ old('project_end_method') == 'Target Date' ? 'selected' : '' }}>
                                                        Target Date</option>
                                                    <option value="Target Goal & Date"
                                                        {{ old('project_end_method') == 'Target Goal & Date' ? 'selected' : '' }}>
                                                        Target Goal & Date</option>
                                                    <option value="Campaign Never Ends"
                                                        {{ old('project_end_method') == 'Campaign Never Ends' ? 'selected' : '' }}>
                                                        Campaign Never Ends</option>
                                                    <option value="Featured"
                                                        {{ old('project_end_method') == 'Featured' ? 'selected' : '' }}>
                                                        Featured</option>
                                                </select>
                                            ...
                                            <div class="row gx-5 mb-0 mb-md-3">
                                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                                    ...
                                                    is-invalid @enderror"
                                                        name="funding_goal" value="{{ old('funding_goal') }}">
                                                    <div class="pincel"></div>
                                            ...
                                            <div class="row gx-5 mb-0 mb-md-3 mt-2">
                                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                                    <label for="" class="form-label mb-0">Benefit Title</label>
                                                    <input type="text" class="form-control" name="benefit_title[]">
                                                </div>

                                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                                    <label for="" class="form-label mb-0">Benefit Price</label>
                                                    <input type="number" class="form-control" name="benefit_price[]">
                                                </div>

                                            </div>
                                            <div class="row gx-5 mb-0 mb-md-3 mt-2">
                                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                                    <label for="" class="form-label mb-0">Benefit MSRP</label>
                                            ...
                                            <div class="row gx-5 mb-0 mb-md-3">
                                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                                    <label for="" class="form-label mb-0">Estimated Delivery
                                                        Date</label>
                                    ...
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                        ...
                                        <div class="row gx-2 mb-0 mb-md-3">
                                            ...
                                            <div class="col-12 col-md-3 mb-3 mb-md-0">
                                                ...
                                                is-invalid @enderror" value="{{ old('founder_state') }}">
                                                @error('founder_state')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="xxx-xxx-xxxx" name="phone" value="{{ old('phone') }}">
                                            <div class="pincel"></div>
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('cart_number') is-invalid @enderror"
                                                name="cart_number" value="{{ old('cart_number') }}">
                                            <div class="pincel"></div>
                                            @error('cart_number')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-check mb-4">
                                            <input class="form-check-input  @error('term_conditions') is-invalid @enderror "
