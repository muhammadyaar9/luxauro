            ...
            <div class="container">
                <div class="row col-lg-9 mx-auto gx-5">
                    ...
                    <div class="col-12 col-md-8 gx-0 gx-md-5 px-md-5">
                        {{-- <h2 class="mb-2" style="font-size: 22px; font-weight: 600;"> My Invoice </h2> --}}
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <h5 class="mb-1">Hi <strong>
                                                    {{ isset($order->user->userDetails->name) ? $order->user->userDetails->name : '' }}
                                                </strong>
                                            </h5>
                                        </div>
                                        <div class="card-body ps-0 pe-0">
                                            <div class="row">
                                                <div class="col-sm-6"> <span>Payment
                                                        No.</span><br><strong>INV23456-234</strong> </div>
                                                <div class="col-sm-6 text-end"> <span>Payment
                                                        Date</span><br><strong>{{ date('d-M-Y h:i a') }}
                                                    </strong>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive push">
                                        <table class="table table-bordered table-hover text-nowrap">
                                            <tbody>
                                                ...
                                                @foreach ($order->cart as $orders)
                                                    @if ($orders->vendor_id == auth()->user()->id)
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                ${{ isset($orders->cart->product->product_price) ? number_format($orders->cart->product->product_price) : '' }}
                                                            </td>
                                                            <td class="text-end">
                                                                ${{ isset($orders->cart->product->product_price) ? number_format($orders->cart->product->product_price * $orders->cart->quantity) : '' }}
                                                            </td>
                                                        </tr>
                                                        @php
                                                ...
                                                @endforeach
                                                <tr>
                                                    <td colspan="4" class="font-weight-semibold text-end">Subtotal
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colspan="4" class="font-weight-semibold text-end">Shiping
                                                        Charges</td>
                                                    <td class="text-end">${{ $shipping_charge }}</td>
                                                </tr>
                                                <tr class="text-danger">
                                                    <td colspan="4"
                                                        class="font-weight-bold text-danger text-uppercase text-end h4 mb-0">
                                                        Total Due </td>
                                                    <td class="font-weight-bold text-danger text-end h4 mb-0">

                                                        ${{ number_format($subtotal + $shipping_charge) }}</td>
                                                </tr>
                                                {{-- <tr>
