...
class AboutUsController extends Controller
{
    ...
    {
        $aboutUs = AboutUs::orderBy('id', 'desc')->where('about_us_type', 'Luxauro')->first();
        $checkaboutUs = AboutUs::orderBy('id', 'desc')->where('about_us_type', 'Luxauro')->count();
        return view('frontend.admin.aboutUs.index', compact('aboutUs', 'checkaboutUs'));
    }
    ...
    {
        return view('frontend.admin.aboutUs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validate->fails()) {
            ...
            $aboutUs->save();
            return redirect()->route('about-us.index')->with('success', 'About Us Added Successfully');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('frontend.admin.aboutUs.edit', compact('editAboutUs'));
    }
