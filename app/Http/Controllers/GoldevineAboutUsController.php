...
class GoldevineAboutUsController extends Controller
{
    /**
    ...
    {
        $aboutUs = AboutUs::orderBy('id', 'desc')->where('about_us_type', 'Goldevine')->first();
        $aboutUscount  = AboutUs::orderBy('id', 'desc')->where('about_us_type', 'Goldevine')->count();
        return view('frontend.admin.goldevineabout.index', compact('aboutUs','aboutUscount'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validate->fails()) {
            ...
            $aboutUs->save();
            return redirect()->route('goldevine-about-us.index')->with('success', 'About Us Added Successfully');
        }
    }
    ...
    public function show($id)
    {
        ...
        return redirect()->route('goldevine-about-us.index')->with('success', 'About Us Deleted Successfully');
    }
