...
class CreateCharterSpecificationGeneralsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('charter_specification_generals', function (Blueprint $table) {
            $table->id();
            $table->string('charter_id')->nullable();
    ...
    {
        Schema::dropIfExists('charter_specification_generals');
    }
}
